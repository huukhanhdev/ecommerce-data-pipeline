  ...
  insert into `staging_analytics`.`fact_orders__dbt_backup`
        ("order_item_key", "item_id", "order_id", "user_key", "product_key", "seller_key", "date_key", "quantity", "unit_price", "shipping_fee", "total_amount", "status", "payment_method", "order_created_at")-- fact_orders.sql
