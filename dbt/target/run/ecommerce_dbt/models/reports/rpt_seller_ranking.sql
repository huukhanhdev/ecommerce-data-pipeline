  ...
  insert into `staging_analytics`.`rpt_seller_ranking__dbt_backup`
        ("f.seller_key", "seller_name", "seller_city", "seller_rating", "category_name", "total_orders", "total_units_sold", "total_revenue", "avg_order_value", "returned_orders", "cancelled_orders", "revenue_rank_in_category", "revenue_percentile", "return_rate_pct")-- rpt_seller_ranking.sql
